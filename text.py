...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 560
s1='E:\作业\大二下\python\python大作业/'
 
 
# 地图类 v1.2 完善地图类
class Map:
    images_list = [s1+'imgs/map1.png',s1+'imgs/map2.png']
...
class Sunflower(Plant):
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load(s1+'imgs/sunflower.png')
...
class PeaShooter(Plant):
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load(s1+'imgs/peashooter.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        self.price = 50
...
class PeaBullet(pygame.sprite.Sprite):
    def __init__(self,peashooter):
        self.live = True
        self.image = pygame.image.load(s1+'imgs/peabullet.png')
        self.damage = 50
        self.speed  = 10
        self.rect = self.image.get_rect()
...
class Zombie(pygame.sprite.Sprite):
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load(s1+'imgs/zombie.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        self.hp = 400
